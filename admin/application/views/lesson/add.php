<?php $this->load->view('public/header'); ?>
    <div class="main col-sm-9 col-md-10 ">
        <div class="bgf">
            ...
            <input type="hidden" value="" id="lesson_strength">
            
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label"><span class="text-red">*</span>课程名称</label>

                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="请输入课程名称" id="lesson_name">
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <label class="radio-inline">
                                <input type="radio" name="lesson_type" value="1" checked> 精品小班课
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="lesson_type"  value="2" > 私教课
                            </label>

                            <label class="radio-inline">
                                <input type="radio" name="lesson_type"  value="3" > 伙伴课
                            </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="请输入时长" id="lesson_time_length" >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control moneyInput" placeholder="请输入课程价格" id="lesson_price">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="3" id="lesson_remind"></textarea>
                    </div>
                </div>
