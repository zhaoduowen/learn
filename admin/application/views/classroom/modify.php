<?php $this->load->view('public/header'); ?>
    <div class="main col-sm-9 col-md-10 ">
        <div class="bgf">
            <ol class="breadcrumb">
                <!-- <li><a href="#">教室管理 </a></li> -->
                <li class="active">编辑教室</li>
            </ol>

            <form class="form-horizontal">
                <input type="hidden" id="classroom_id" value="<?php echo $data['classroom_id']?>">
                <input type="hidden" id="site_id" value="<?php echo $data['site_id']?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="请输入教室" id="classroom_name" value="<?php echo $data['classroom_name']?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="请输入场地人数" id="classroom_people_num" value="<?php echo $data['classroom_people_num']?>">
                    </div>
                </div>
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div id="timetableList">
                            <?php
                            if ($time_arr) {
                                foreach ($time_arr as $k => $p) {?>

                                <div class="form-inline li">
 <select class="begin_time">
    <?php foreach ($timeList as $key => $value) {
        echo "<option value='{$value}' ".($value==$p['begin_time']?'selected':'').">".$value.'</option>';
    }?>
</select>
--
<select class="end_time">
    <?php foreach ($timeList as $key => $value) {
        echo "<option value='{$value}' ".($value==$p['end_time']?'selected':'').">".$value.'</option>';
    }?>
</select>
