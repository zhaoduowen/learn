            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9 file-img">
                        <div id="uploadPic_success">
                         <?php if($data['teacher_avatar'] != ''){?>
                        <div class="img-item">
                            <input type='hidden'  name='teacherPic' value='<?php echo $data['teacher_avatar'];?>'/>
                            <img src="<?php echo G_IMAGE_DOMAIN.$data['teacher_avatar'];?>" width="100" height="100" alt="" class="img-rounded">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="请输入老师名称" id="teacher_name" value="<?php echo $data['teacher_name']?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <li><input  type="checkbox" name="change_site_name[]" value='<?php echo $value['site_id']?>' <?php if(in_array($value['site_id'], $hasSite)){?> checked="checked" <?php }?>><?php echo $value['site_name']?></li>
                       <?php endforeach ?>
                        </ul>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="3" id="teacher_sign"  max-length="30"><?php echo $data['sign']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="请输入老师电话" id="teacher_mobile"  value="<?php echo $data['mobile']?>">
                    </div>
                </div>
               ...
               <!--  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="3" id="teacher_remark"> <?php echo $data['remark']?></textarea>
                    </div>
                </div>
                -->
