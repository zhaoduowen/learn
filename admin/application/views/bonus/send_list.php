    ...
    <div class="main col-sm-9 col-md-10 ">
        <div class="bgf">
            <ol class="breadcrumb">
                ...
                <li class="active">发放数量</li>
            </ol>
            <form action="/bonus/sendlist" method="post">
            ...
            <div class="self-info">
                <div class="form-inline">
                  <div class="form-group">
                    <label class="" for="keyword">参数</label>
                    <input type="input" class="form-control"  name="param"
                           value="<?php echo $where['param'] ?>" placeholder="关键字">
                </div>  
                <div class="form-group">
