    ...
    <div class="main col-sm-9 col-md-10 ">
        <div class="bgf">
            ...
            <div class="self-info">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary"  type="button" onclick="location.href='/site/add'">新增场地</button>
                </div>
                <div class="db"></div>
                    ...
                    <tr>
                        ...
                        <td><?php if(!empty($item['classroom'])){
                            foreach ($item['classroom'] as $k => $v) {
                                echo "<a href='/classroom/modify?id=".$v['classroom_id']."'>".$v['classroom_name']."</a>&nbsp;&nbsp;";
                        }} ?></td>
                        <td>
                        <input  value="添加教室" class="btn btn-primary" type="button" onclick="location.href='/classroom/add?site_id=<?php echo $item['site_id'] ?>'">
