...
.timetableli{    
   ...
   <div class="main col-sm-9 col-md-10 ">
        <div class="bgf">
            ...
            <input type="hidden" value="<?php echo $data['site_id'];?>" id="site_id">
             <input type="hidden" id="lng" value="<?php echo $data['x_coor'];?>">
            <input type="hidden" id="lat" value="<?php echo $data['y_coor'];?>">
            <div class="form-group">
                    ...
                    <div class="col-sm-9 file-img">
                        ...
                        <?php if($data['site_image'] != ''){?>
                        <div class="img-item">
                            <input type='hidden'  name='sitePic' value='<?php echo $data['site_image'];?>'/>
                            <img src="<?php echo G_IMAGE_DOMAIN.$data['site_image'];?>" width="100" height="100" alt="" class="img-rounded">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="请输入场地名称" id="site_name" value="<?php echo $data['site_name']?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input style="width: 350px;" type="text" class="form-control" placeholder="请输入场地地址" id="site_address"  value="<?php echo $data['site_address']?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" placeholder="请输入联系电话" id="site_mobile"  value="<?php echo $data['site_mobile']?>">
                    </div>
                </div>
                        ...
                        <div class="col-sm-9">
                         <?php foreach ($type as $key=>$item) { ?>
                          <label class="checkbox-inline">
                                <input  class="checkbox" type="checkbox" value="<?php echo $key ?>" name="lesson_type_limit[]" <?php if(strpos($data['lesson_type_limit'],"$key")){?> checked="checked" <?php }?>> <?php echo $item?>
                            </label>
                        <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <p><b><?=$lessonType[$key]?></b></p>
                         ...
                         <?php if(!empty($rows)){foreach ($rows as $k=>$item) { ?>
                          <li>
                                <input  type="checkbox" value="<?php echo $item['lesson_id'] ?>" name="lesson_arr[]" <?php if(in_array($item['lesson_id'], $hasLesson)){?> checked="checked" <?php }?>> <?php echo $item['lesson_name']?>
                            </li>
                        <?php }} ?>
                         </ul>
                         </div>  
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="3" id="site_remark"> <?php echo $data['site_remark'];?></textarea>
                    </div>
                </div>
